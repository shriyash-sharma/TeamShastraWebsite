...
export const metadata: Metadata = pageMetadata(
  "/about",
  "About | TeamShastra",
  "Learn about TeamShastra, a field service management software platform currently in public beta before production release."
);
    ...
    <main>
      <section className="page-hero">
        <div className="section-inner">
          ...
          <p className="page-lead">
            {betaStatus} {releaseNote} The public website explains the product while the application domain hosts beta signup, login, and test workspaces.
          </p>
        ...
        <div className="section-inner split-grid">
          ...
          <div className="card">
            ...
            <ul className="list">
              ...
              <li>Visitor creates a test company and evaluates TeamShastra before production release.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-inner banner">
          <div>
            <h2>Help test TeamShastra before launch.</h2>
            <p>
              {betaStatus} {releaseNote}
            </p>
          </div>
          <a className="button primary" href={signupUrl}>
            Join Beta
