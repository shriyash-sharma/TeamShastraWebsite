...
export const metadata: Metadata = pageMetadata("/pricing", "Pricing | TeamShastra", "TeamShastra public beta pricing information for field service teams testing the platform.");
